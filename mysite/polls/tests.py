...
class TestQuestionModel(TestCase):
    ...
    def test_was_published_recently_with_recent_question(self):
        ...
        """
        past_question = create_question(question_text="Recent question.", days=0.999)
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_past_question(self):
        """
        Questions with a created_at in the past are displayed.
        """
    ...
    def test_future_question(self):
        """
        Questions with a created_at in the future are not displayed.
        """
...
class QuestionResultsViewTests(TestCase):
    ...
    def test_future_question(self):
        """
        The results view of a question with a created_at in the future
        returns a 404 not found.
        """
        future_question = create_question(
            question_text="Future question.", days=5
    ...
    def test_past_question(self):
        """
        The results view of a question with a created_at in the past
